export const translations = {
  fr: {
    ...
    hero: {
      ...
      headline: "Votre Protection des Données,",
      subheadline: "Visualisée en Temps Réel",
      ...
      terminal: {
        command: "anonyto scan --data sensitive_data.txt",
        scanning: "Analyse des données...",
        detecting: "Détection d'informations sensibles...",
        anonymizing: "Application de l'anonymisation...",
        exposedTitle: "Données Exposées",
        anonymizedTitle: "Anonymisées",
        vulnerable: "⚠ Vulnérable",
        secured: "✓ Sécurisé",
        protectedPercent: "0% Protégé",
        fullProtectedPercent: "100% Protégé",
        statsDetected: "Détectées",
        statsProtected: "Protégé",
        statsLatency: "Latence",
        statsPrivacy: "Confidentialité",
        complete: "Anonymisation terminée. Vos données sont maintenant sécurisées.",
        replayButton: "Demo",
        statusOnline: "Système en ligne • Protection en temps réel active",
        dataLabels: {
          email: "Email",
          phone: "Téléphone",
      ...
      dashboard: {
        online: "En ligne",
        riskReduced: "Risque réduit",
        savings: "Économie",
        perIncident: "Par incident évité",
    ...
    security: {
      ...
      stats: {
        secure: "Sécurisé",
        private: "Privé",
        privateDesc: "Vos données vous appartiennent",
      ...
      features: [
        ...
        },
        {
          ...
          description:
            "Accédez à vos données où que vous soyez, à tout moment.",
        },
      ],
      certificationBadge: "Certifié et conforme aux normes européennes",
    },
    integrations: {
      ...
      badges: {
        certified: "Partenaires certifiés",
        enterprise: "Prêt pour l'entreprise",
        secure: "Intégration sécurisée",
      },
    },
    pricing: {
  ...
  en: {
    ...
    hero: {
      ...
      headline: "Your Data Protection,",
      subheadline: "Visualized in Real-Time",
      ...
      terminal: {
        ...
        anonymizing: "Applying anonymization...",
        exposedTitle: "Exposed Data",
        anonymizedTitle: "Anonymized",
        vulnerable: "⚠ Vulnerable",
        secured: "✓ Secured",
        protectedPercent: "0% Protected",
        fullProtectedPercent: "100% Protected",
        statsDetected: "Detected",
        statsProtected: "Protected",
        statsLatency: "Latency",
        statsPrivacy: "Privacy Score",
        complete: "Anonymization complete. Your data is now secure.",
        replayButton: "Demo",
        statusOnline: "System Online • Real-time Protection Active",
        dataLabels: {
          email: "Email",
          phone: "Phone",
          ssn: "SSN",
      ...
      dashboard: {
        ...
        savings: "Savings",
        perIncident: "Per incident avoided",
    ...
    modules: {
      ...
      items: [
        ...
        },
        {
          ...
          description: "Your data stays encrypted in transit and at rest",
        },
        {
    ...
    security: {
      ...
      stats: {
        secure: "Secure",
        private: "Private",
        privateDesc: "Your data belongs to you",
      ...
      features: [
        {
          ...
          description:
            "Your data is protected automatically, without any effort on your part.",
        },
        {
        ...
        },
        {
          ...
          description:
            "Never lose your data. Everything is backed up permanently.",
        },
        {
